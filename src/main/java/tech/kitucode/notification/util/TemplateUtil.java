...
public class TemplateUtil {
    public static String sendSpecialMessage(String owner, String message) {
        return "<!doctype html>" +
                ...
                "</head>" +
                "<body> <table id=\"outer-table\"> <tbody> <th> <td> <p>&nbsp;</p></td></th> <tr> <td colspan=\"1\"></td><td colspan=\"1\" id=\"content-data\"> <table id=\"logo-table\"> <tbody> <tr> <td colspan=\"1\"> Emails by Kitunda </td><td align=\"right\" colspan=\"1\"> </td></tr></tbody> </table> <hr/> " +
                "<h3> Hello " + owner + ". </h3> " +
                "<p>"+message+" </p><br/> " +
                "<p> <i><strong></strong>Brian cares about you.</strong></i> </p><p><br/> </p><hr/> <p id=\"footer\" align=center> Brian Kitunda, +254740272915</p></td><td colspan=\"1\"></td></tr><th> <td> <p>&nbsp;</p></td></th> </tbody> </table></body></html>";
    }
}
